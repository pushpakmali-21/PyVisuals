...
import { ML_LAUNCHPAD_MODULE, getFirstLesson, getLessonById, getAdjacentLessons } from "@/lib/modules/ml-launchpad";
import { LearningSidebar } from "@/components/modules/LearningSidebar";
import { LessonContent } from "@/components/modules/LessonContent";

export default function MLLaunchpadPage() {
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-line bg-[#111722] px-4 z-20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded bg-[#ec4899]/20 flex items-center justify-center text-xs font-bold text-[#ec4899]">M</div>
            <span className="font-semibold text-slate-100">ML Launchpad</span>
